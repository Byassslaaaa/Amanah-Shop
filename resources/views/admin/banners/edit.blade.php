...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Perbarui banner yang ditampilkan di halaman utama</p>
        </div>
...
<form action="{{ route('admin.banners.update', $banner) }}" method="POST" class="space-y-6" x-data="{
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="button_link" name="button_link" value="{{ old('button_link', $banner->button_link) }}"
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div>
                    ...
                    <input type="hidden" id="image" name="image" value="{{ old('image', $banner->image) }}">
                    @error('image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">
                        Format: JPEG, PNG, JPG. Rekomendasi ukuran: 1920x600px. Kosongkan jika tidak ingin mengubah gambar.
                    </p>
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="order" name="order" value="{{ old('order', $banner->order) }}" min="0" required
