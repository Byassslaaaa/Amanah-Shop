...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center space-x-2">
            <a href="{{ route('admin.credits.payments.overdue') }}"
            ...
            <a href="{{ route('admin.credits.payments.report') }}"
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 mt-1">{{ $paidCount }}</p>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('admin.credits.payments.index') }}" class="flex flex-wrap items-end gap-4">
            ...
            <a href="{{ route('admin.credits.payments.index') }}" class="px-6 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
                Reset
            </a>
        </form>
    </div>
                    ...
                    <tr class="hover:bg-gray-50 {{ $payment->due_date->isPast() && $payment->status != 'paid' ? 'bg-red-50' : '' }}">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <a href="{{ route('admin.credits.payments.show', $payment) }}" class="text-blue-600 hover:text-blue-900" title="Detail">
                                ...
                                <a href="{{ route('admin.credits.manual.payment-form', $payment->manualCredit) }}" class="text-green-600 hover:text-green-900" title="Catat Pembayaran">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
